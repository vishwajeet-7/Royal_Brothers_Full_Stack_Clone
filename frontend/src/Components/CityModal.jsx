...
function CityModal({ isOpen, setIsOpen, setSelectedCity }) {
  ...
  const images = [
    {
      name: "Agra",
      url: "https://d3vp2rl7047vsp.cloudfront.net/cities/round_images/000/000/039/original/Agra_new.jpg",
    },
    {
      name: "Haridwar",
      ...
      >
        ...
        <ModalContent w="80%">
          ...
          <ModalFooter w={"fit-content"} m={"auto"}>
            ...
            <WiggleText>Select City To Continue</WiggleText>
          </ModalFooter>
        </ModalContent>
      </Modal>
    </>
